...
parameter_types! {
	...
	pub const EnterDepositAmount: Balance = 2_000_000 * SILA;
        pub const ExtendDuration: BlockNumber = 2 * HOURS;
	pub const ExtendDepositAmount: Balance = 1_000_000 * SILA;
...
parameter_types! {
	pub const IndexDeposit: Balance = 1 * SILA;
}
...
parameter_types! {
	pub const ExistentialDeposit: Balance = 1 * SILA;
...
parameter_types! {
	pub const TransactionByteFee: Balance = 10 * MILLISILA;
...
parameter_types! {
	...
	// signed config
	pub const SignedRewardBase: Balance = 1 * SILA;
	pub const SignedFixedDeposit: Balance = 1 * SILA;
	pub const SignedDepositIncreaseFactor: Percent = Percent::from_percent(10);
	pub const SignedDepositByte: Balance = 1 * uSILA;
...
parameter_types! {
	...
	pub const SubmissionDeposit: Balance = 100 * SILA;
...
parameter_types! {
	...
	pub const MinimumDeposit: Balance = 100 * SILA;
...
parameter_types! {
	pub const CandidacyBond: Balance = 10 * SILA;
...
parameter_types! {
	...
	pub const TipReportDepositBase: Balance = 1 * SILA;
	pub const DataDepositPerByte: Balance = 1 * uSILA;
...
parameter_types! {
	...
	pub const BountyValueMinimum: Balance = 5 * SILA;
	pub const BountyDepositBase: Balance = 1 * SILA;
	pub const CuratorDepositMultiplier: Permill = Permill::from_percent(50);
	pub const CuratorDepositMin: Balance = 1 * SILA;
	pub const CuratorDepositMax: Balance = 100 * SILA;
...
parameter_types! {
	pub const ChildBountyValueMinimum: Balance = 1 * SILA;
}
...
impl pallet_tips::Config for Runtime {
	...
	type MaxTipAmount = ConstU128<{ 500 * SILA }>;
...
parameter_types! {
	...
	pub const SubAccountDeposit: Balance = 2 * SILA;   // 53 bytes on-chain
...
parameter_types! {
	pub const ConfigDepositBase: Balance = 5 * SILA;
	pub const FriendDepositFactor: Balance = 50 * uSILA;
	pub const MaxFriends: u16 = 9;
	pub const RecoveryDeposit: Balance = 5 * SILA;
}
...
parameter_types! {
	...
	pub const PeriodSpend: Balance = 500 * SILA;
...
parameter_types! {
	pub const MinVestedTransfer: Balance = 100 * SILA;
...
parameter_types! {
	pub const AssetDeposit: Balance = 100 * SILA;
	pub const ApprovalDeposit: Balance = 1 * SILA;
	pub const StringLimit: u32 = 50;
	pub const MetadataDepositBase: Balance = 10 * SILA;
	pub const MetadataDepositPerByte: Balance = 1 * SILA;
}
...
impl pallet_assets::Config<Instance1> for Runtime {
	...
	type AssetAccountDeposit = ConstU128<SILA>;
...
parameter_types! {
	...
	pub const PoolSetupFee: Balance = 1 * SILA; // should be more or equal to the existential deposit
...
parameter_types! {
	...
	pub const MinBid: Balance = 100 * SILA;
...
parameter_types! {
	pub const CollectionDeposit: Balance = 100 * SILA;
	pub const ItemDeposit: Balance = 1 * SILA;
...
parameter_types! {
	pub const Budget: Balance = 10_000 * SILA;
...
parameter_types! {
	pub const MigrationSignedDepositPerItem: Balance = 1 * uSILA;
	pub const MigrationSignedDepositBase: Balance = 20 * SILA;
...
parameter_types! {
	...
	pub const AllyDeposit: Balance = 10 * SILA;
...
parameter_types! {
	pub StatementCost: Balance = 1 * SILA;
	pub StatementByteCost: Balance = 100 * MILLISILA;
...
parameter_types! {
	...
	pub const MinimumCreditPurchase: Balance =  100 * MILLISILA;
}
...
pub mod dynamic_params {
	...
	pub mod storage {
		...
		#[codec(index = 0)]
		pub static BaseDeposit: Balance = 1 * SILA;

		/// Configures the per-byte deposit of storing some data.
		#[codec(index = 1)]
		pub static ByteDeposit: Balance = 1 * uSILA;
	}
