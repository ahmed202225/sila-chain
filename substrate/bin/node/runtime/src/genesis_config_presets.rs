...
//! Genesis Presets for the sila Runtime
...
pub const ENDOWMENT: Balance = 10_000_000 * SILA;
...
pub fn sila_genesis(
	...
	build_struct_json_patch!(RuntimeGenesisConfig {
		...
		nomination_pools: NominationPoolsConfig {
			min_create_bond: 10 * SILA,
			min_join_bond: 1 * SILA,
		},
...
pub fn get_preset(id: &PresetId) -> Option<Vec<u8>> {
	...
	let patch = match id.as_ref() {
		sp_genesis_builder::DEV_RUNTIME_PRESET => sila_genesis(
		...
		sp_genesis_builder::LOCAL_TESTNET_RUNTIME_PRESET => sila_genesis(
			vec![
